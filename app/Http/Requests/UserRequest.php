...
class UserRequest extends FormRequest
{
    ...
    public function withValidator($validator)
    {
        ...
        $validator->sometimes('parents.0.phone', 'required|digits:9|unique:parentts,phone', fn($input) => $input->role === 'Child');
        ...
        $validator->sometimes('parents.1.phone', 'required|digits:9|unique:parentts,phone', fn($input) => isset($input->parents[1]['phone']));
    ...
    public function rules(): array
    {
        return [
            ...
            'role' => 'required|in:Manager,Teacher,Child',
            ...
            'parents.*.phone' => 'nullable|digits:9|unique:parentts,phone|distinct',
